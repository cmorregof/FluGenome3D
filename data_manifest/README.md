...
2. **Cryptographic derived-data layer**: uses only real derived exports under `app/data/*.safe.json`, with aggregate views, hash-based IDs, AntigenLM reduced coordinates, and public PDB alignment-QC summaries.
